              ...
              <div className="compact-selection">
                    ...
                    {formData.coResponsibles.map((memberId) => {
                      ...
                      return member ? (
                        <div key={memberId} className="selected-member">
                          <img src={member.avatar_url || '/default-avatar.png'} alt={member.full_name || `${member.first_name} ${member.last_name}`} className="selected-avatar" />
                          <div className="selected-info">
                ...
                <div className="selection-list">
                  {getFilteredMembers(searchTerms.coResponsibles).map((member: any) => (
                    ...
                    >
                      <img src={member.avatar_url || '/default-avatar.png'} alt={member.full_name || `${member.first_name} ${member.last_name}`} className="item-avatar" />
                      <div className="item-info">
