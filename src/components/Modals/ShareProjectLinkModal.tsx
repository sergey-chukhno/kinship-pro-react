...
interface ShareProjectLinkModalProps {
  isOpen: boolean;
  onClose: () => void;
  token: string | null;
}

const ShareProjectLinkModal: React.FC<ShareProjectLinkModalProps> = ({ isOpen, onClose, token }) => {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h2>Partager un lien vers le projet</h2>
        ...
        <div className="modal-body">
          <div className="space-y-4">
            <p className="text-gray-600">
              Toute personne disposant de ce lien pourra consulter les informations du projet et le rejoindre.
            </p>
...
export default ShareProjectLinkModal;
